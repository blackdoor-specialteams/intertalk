...
public class MessagesRecord extends UpdatableRecordImpl<MessagesRecord> implements Record8<byte[], String[], String, Timestamp, Timestamp, String, String, String> {

    private static final long serialVersionUID = -330387013;
     ...
     */
    @Override
    public Row8<byte[], String[], String, Timestamp, Timestamp, String, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row8<byte[], String[], String, Timestamp, Timestamp, String, String, String> valuesRow() {
     ...
     */
    @Override
    public MessagesRecord value1(byte[] value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public MessagesRecord values(byte[] value1, String[] value2, String value3, Timestamp value4, Timestamp value5, String value6, String value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MessagesRecord(byte[] id, String[] to, String from, Timestamp sentAt, Timestamp receivedAt, String message, String messageFormatted, String format) {
        super(Messages.MESSAGES);
